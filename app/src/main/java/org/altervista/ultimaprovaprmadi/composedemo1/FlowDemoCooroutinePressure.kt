...
import org.altervista.ultimaprovaprmadi.composedemo1.viewmodel.MyViewModelPressure

class FlowDemoCooroutinePressure : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val viewModel = viewModel<MyViewModelPressure>()
