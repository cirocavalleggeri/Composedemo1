...
import org.altervista.ultimaprovaprmadi.composedemo1.viewmodel.MyViewModelOperator

class FlowDemoOperator : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val viewModel = viewModel<MyViewModelOperator>()
